...
import { EVENTTYPES, BREADCRUMBTYPES } from '@metaweb/common';
import { validateOption, getTimestamp, _support } from '@metaweb/utils';
import { BreadcrumbData, InitOptions } from '@metaweb/types';
