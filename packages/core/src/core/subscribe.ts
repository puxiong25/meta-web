...
import { getFlag, nativeTryCatch, setFlag } from '@metaweb/utils';
import { ReplaceHandler, ReplaceCallback } from '@metaweb/types';
import { EVENTTYPES } from '@metaweb/common';
...
export function subscribeEvent(handler: ReplaceHandler): boolean {
  console.log('subscribeEvent handler:', handler);
