...
/**
 * 将地址字符串转换成对象，
 * 输入：'https://github.com/puxiong25/meta-web?token=123&name=11'https://github.com/puxiong25/meta-web
 * 输出：{
 *  "host": "github.com",
 *  "path": "/puxiong25/meta-web",
 *  "protocol": "https",
 *  "relative": "/puxiong25/meta-web?token=123&name=11"
 * }
 */
